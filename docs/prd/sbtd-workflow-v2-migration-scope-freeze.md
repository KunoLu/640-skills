...
- 隔离根改标 agent-proposed／待确认（记录时刻 2026-09-23T11:20:09+08:00）：精确路径标为 agent-proposed / pending user confirmation，不满足第 6 节第 3 项。磁盘回读候选路径不存在。未写 live HOME。未 apply。
