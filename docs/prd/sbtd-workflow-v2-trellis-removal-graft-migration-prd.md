...
| P1-16 | P1 | 候选 release-readiness 与可选 rc 发布 | P1-15 | [候选就绪报告](sbtd-workflow-v2-candidate-readiness.md)核对 `a50ade4586a780e2061f9eb20b0c0c58f9426e20`：精确三平台CI、完整328文件副本CLI、固定Graft安装及两平台project-only图验证通过；两路独立review均ready，仅限候选与P2准备，保留P1-15历史partial及AC-20限制。任务PR／状态闭环未完成；rc未创建，tag／sync／真实迁移仍需独立授权 | HITL | checking | — |
