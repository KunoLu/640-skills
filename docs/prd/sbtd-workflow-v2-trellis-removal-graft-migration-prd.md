...
| P1-19 | P1 | developer 按需建立与 worktree 身份解析 | P1-02、P0-06 | AC-06/25；[实施与验证](sbtd-workflow-v2-developer-identity-runtime.md)。显式身份链/窄授权/初始化消费完成；745 tests/183.192s、310文件安装副本10原生场景通过，独立review两个P1红绿关闭，4 P2原级延期。当前dirty/local-only，待精确提交与PR/清理闭环 | AFK | checking | — |
