...
| P0-09 | P0 | 源仓库根七行 ignore、维护说明与精确测试 | R-09 | AC-12/16；根七行精确断言red→green，18项原生Git正反probe及41项workflow contracts通过；切换前磁盘／索引无旧工具或新保留根残留。README两入口与版本化prompt同步；历史lessons原文及保留测试不变，不复制项目模板。待最终head全量／完整smoke及独立review | AFK | checking | — |
