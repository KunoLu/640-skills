...
| P0-08 | P0 | 项目 ignore 的保留／删除／四条新增规则 | P0-03、P0-06 | AC-12/26 子项；[项目ignore契约](sbtd-workflow-v2-project-ignore-contract.md)，D-IMP-11。56条通用规则保留、删14加4；真实CLI红绿、18项相关子集及fresh/legacy/conflict原生smoke已通过；待最终head全量与review，不改源仓root ignore或真实旧数据 | AFK | checking | — |
