...
| P1-03 | P1 | Graft CLI 检测／确认安装／遥测与版本约束 | P0-01、P1-01 | AC-07/10/13相关子项；[实施与验证](sbtd-workflow-v2-graft-cli-runtime.md)。原生636 tests及真实固定包安装/DNT/只读快照通过；两路独立review已关闭2 P1，7 P2延期。正在固定提交并执行最终精确副本验证；不提前验收Windows/host | AFK | checking | — |
