...
| P0-07 | P0 | 原子切换 catalog entries、源目录和 bundled 安装断言 | P0-04、P0-05、P0-06 | AC-11；[切换契约](sbtd-workflow-v2-catalog-cutover-contract.md)：sbtd-task、AGENTS及lessons-record同批移入正式源，退役两旧entry/目录；真实隔离安装14 bundled／19 external，无候选副本 | AFK | in-progress | — |
