...
| P1-05 | P1 | OMP接线、CLI分析及部署证据生产 | P1-02、P1-03、P1-12、P0-05 | AC-08/18/29/33/35部署及恢复输入子项；[实施设计](sbtd-workflow-v2-omp-wiring-runtime.md)。继承去重、无Codex hooks、隔离实际host query及累计部署；复用P1-04守卫，不另起升级/cache/stamp机制。基线899tests及实际OMP18.2.5的8组来源/profile刻画通过，Legacy/Refactoring/DDIA已确认，进入实现 | AFK | in-progress | — |
