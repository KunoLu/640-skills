...
| P1-04 | P1 | Codex接线、显式opt-in hooks及部署证据生产 | P1-02、P1-03、P1-12、P0-05 | AC-08/18/29/33/35的部署及恢复输入子项；[实施边界](sbtd-workflow-v2-codex-wiring-runtime.md)。实现PR #41已合入`747b27024556a1c284b955883f9635ec93e5a3f0`，精确head`11b00a3…`886tests通过。后置复核新发现4项P1（长连接图重载、Python启动环境、失效hook根）；补救分支`p1-04-codex-runtime-hardening`继续修复并独立PR验证，不提前done。GitHub REVIEW_REQUIRED与独立源码复核区别见状态纠正记录 | AFK | blocked | — |
