...
| P1-02 | P1 | 按需脚手架、最小状态校验与 bootstrap 边界 | P1-01、P0-08 | AC-03/12/13/23相关子项；[实施边界与验证](sbtd-workflow-v2-on-demand-bootstrap.md)。提交前587 tests及完整隔离副本/11组真实CLI通过；独立review和精确提交复验进行中，Windows仍归P1-08 | AFK | checking | — |
