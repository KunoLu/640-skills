...
|---|---|---:|---|---|---|
| Codex | openai/codex | v0.144.1 | stable-only | 是 | 核心 Coding Agent |
| Trellis | mindfold-ai/trellis | v0.6.6 | stable-only | 是 | 复杂任务编排 / TDD workflow |
...
| 类别 | 工具 | 当前版本记录 |
|---|---|---:|
| Coding Agent | Codex | v0.144.1 |
| Agent Harness | Trellis | v0.6.6 |
